...
ScriptureAudioBtn.addEventListener("click", (e) =>{
  ...
  if(!playing){
    ...
    console.log(window.responsiveVoice.utterances)
    playing = true;
    window.responsiveVoice.utterances[window.responsiveVoice.utterances.length-1].onend = function(){
        playing = false;
    };
  } else{
    playing = false
