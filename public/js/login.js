...
var prettify = function(msg) {
    ...
    msg = msg.replace(inlineCodeCheck, "<div style=\"padding: 2px;font-family: monospace;background-color: rgb(230, 230, 230);\">$1</div>");
    ...
    msg = msg.replace(glowCheck, "<span style='text-shadow:0px 0px 15px $1, 0px 0px 15px $1, 0px 0px 15px $1, 0px 0px 15px $1, 0px 0px 15px $1, 0px 0px 15px $1, 0px 0px 15px $1'>$2</span>");
    for (var i in replacements) {
        var r = new RegExp(i,"g");
        msg = msg.replace(r, "<img style = 'height: 1em; width: auto;' alt ='https://www.khanacademy.org/computer-programming/smile/" + replacements[i] + "'src = 'https://www.khanacademy.org/computer-programming/smile/" + replacements[i] + "/latest.png'</img>");
    }
    // ==================================================
    msg = msg.replace(/~/gi, "");
    return msg;
...
if (typeof document.addEventListener === "undefined" || hidden === undefined) {
  console.log("This webpage requires a browser, such as Google Chrome or Firefox, that supports the Page Visibility API.");
} else {
  document.addEventListener(visibilityChange, handleVisibilityChange, false);
}
window.onunload = function(event) {socket.emit("idle",username)};
/*(function(){
var itl=null;
